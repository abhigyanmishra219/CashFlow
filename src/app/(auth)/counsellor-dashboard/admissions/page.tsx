                ...
                <div className="p-8 pb-32">
                            ...
                            {searchResult.stage === "NOT_FOUND" && (
                                <div className="bg-rose-50 border border-rose-200 rounded-2xl p-6">
                                    ...
                                    <div className="flex items-center gap-3">
                                        <button className="bg-white border border-rose-200 hover:bg-rose-100 text-rose-700 text-xs font-bold px-4 py-2 rounded-xl transition-colors">
                                            Create New Enquiry
                                        </button>
                                        <button className="bg-rose-600 hover:bg-rose-700 text-white text-xs font-bold px-4 py-2 rounded-xl transition-colors shadow-sm">
                            ...
                            {searchResult.stage === "ENQUIRY" && searchResult.data.length > 0 && (
                                <div className="space-y-6">
                                    {searchResult.data.map((lead: any, index: number) => {
                                        ...
                                        return (
                                            <div key={index} className={c("bg-amber-50 border-amber-200", "bg-emerald-50 border-emerald-200") + " border rounded-2xl p-6"}>
                                                    ...
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div>
                                                            <h3 className={c("text-amber-900", "text-emerald-900") + " text-sm font-bold flex items-center gap-2"}>
                                                                ...
                                                                <span className={c("bg-amber-200 text-amber-800", "bg-emerald-200 text-emerald-800") + " text-[9px] px-2 py-0.5 rounded-md uppercase tracking-wider"}>{lead.enquiryId}</span>
                                                            </h3>
                                                ...
                                                {!isAdmitted && (
                                                    <div className="flex flex-wrap items-center gap-3">
                                                        <button onClick={() => { setSelectedLead(lead); setOpenTaskModalOnLoad(false); }} className={c("border-amber-200 hover:bg-amber-100 text-amber-700", "border-emerald-200 hover:bg-emerald-100 text-emerald-700") + " bg-white border text-xs font-bold px-4 py-2 rounded-xl transition-colors"}>
                                                            View Enquiry
                                                        </button>
                                                        <button onClick={() => { setSelectedLead(lead); setOpenTaskModalOnLoad(true); }} className={c("border-amber-200 hover:bg-amber-100 text-amber-700", "border-emerald-200 hover:bg-emerald-100 text-emerald-700") + " bg-white border text-xs font-bold px-4 py-2 rounded-xl transition-colors"}>
                                                            Schedule Follow-up
                                                        </button>
                                                        <button onClick={() => { setLeadForAdmission(lead); setIsAdmissionModalOpen(true); }} className="bg-emerald-500 hover:bg-emerald-600 text-white text-xs font-bold px-4 py-2 rounded-xl transition-colors shadow-sm shadow-emerald-500/20 ml-auto">
                                ...
                                <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-6">
                                    <div className="flex items-center gap-3 mb-6">
                                        ...
                                        <div>
                                            <h3 className="text-sm font-bold text-emerald-900 flex items-center gap-2">
                                                ...
                                                <span className="bg-emerald-200 text-emerald-800 text-[9px] px-2 py-0.5 rounded-md uppercase tracking-wider">{searchResult.data.admissionNumber}</span>
                                            </h3>
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6 p-4 bg-white/60 rounded-xl border border-emerald-100">
                                        <div>
                                            ...
                                            <p className="text-xs font-bold text-emerald-950">{searchResult.data.studentName}</p>
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs font-bold text-emerald-950">{searchResult.data.feeStatus} <span className="text-emerald-600 font-semibold">(₹{searchResult.data.outstandingAmount} due)</span></p>
                                        </div>
                                    </div>

                                    <div className="flex flex-wrap items-center gap-3">
                                        <button className="bg-white border border-emerald-200 hover:bg-emerald-100 text-emerald-700 text-xs font-bold px-4 py-2 rounded-xl transition-colors">
                                            Open Admission Ledger
                                        </button>
                                        <button className="bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold px-4 py-2 rounded-xl transition-colors shadow-sm">
                                            Collect Fees
                                        </button>
                                        <button className="bg-white border border-emerald-200 hover:bg-emerald-100 text-emerald-700 text-xs font-bold px-4 py-2 rounded-xl transition-colors">
                                            View Admission Details
                                        </button>
                                        <button className="bg-white border border-emerald-200 hover:bg-emerald-100 text-emerald-700 text-xs font-bold px-4 py-2 rounded-xl transition-colors ml-auto">
                            ...
                            {searchResult.stage === "STUDENT" && (
                                <div className="bg-blue-50 border border-blue-200 rounded-2xl p-6">
                                    <div className="flex items-center gap-3 mb-6">
                                        ...
                                        <div>
                                            <h3 className="text-sm font-bold text-blue-900 flex items-center gap-2">
                                                ...
                                                <span className="bg-blue-200 text-blue-800 text-[9px] px-2 py-0.5 rounded-md uppercase tracking-wider">{searchResult.data.studentId}</span>
                                            </h3>
                                            <p className="text-xs font-semibold text-blue-700/80">This student is currently active in ongoing batches.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex flex-wrap items-center gap-3">
                                        ...
                                        <button className="bg-white border border-blue-200 hover:bg-blue-100 text-blue-700 text-xs font-bold px-4 py-2 rounded-xl transition-colors">
                                            Collect Fees
                                        </button>
                                        <button className="bg-white border border-blue-200 hover:bg-blue-100 text-blue-700 text-xs font-bold px-4 py-2 rounded-xl transition-colors">
                    ...
                    <div className="flex items-center gap-8 border-b border-slate-200 mb-6">
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 pb-3 text-sm font-bold border-b-2 transition-colors ${activeTab === "Concession Approvals" ? "border-indigo-600 text-indigo-700" : "border-transparent text-slate-500 hover:text-slate-700 hover:border-slate-300"
                                }`}
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4">
