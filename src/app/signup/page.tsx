      ...
      <div className="w-full max-w-md rounded-2xl border border-slate-800 bg-slate-900/60 p-8 shadow-2xl backdrop-blur-xl transition-all duration-300 hover:border-indigo-500/30">
        ...
        {isSuccess ? (
          <div className="flex flex-col items-center justify-center py-6 text-center animate-fade-in">
            ...
            <Link
              href="/login"
              className="mt-6 inline-flex justify-center rounded-xl bg-indigo-600 px-5 py-2.5 text-sm font-semibold text-white hover:bg-indigo-500 shadow-lg shadow-indigo-600/20 transition-colors"
            >
              Go to Login
            </Link>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`block w-full rounded-xl border bg-slate-950/40 py-3 pl-10 pr-4 text-sm text-slate-100 placeholder-slate-500 transition-all duration-200 outline-none
                    ${errors.name ? "border-rose-500/50 focus:border-rose-500 focus:ring-1 focus:ring-rose-500" : "border-slate-800 focus:border-indigo-500/80 focus:ring-1 focus:ring-indigo-500/80"}`}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`block w-full rounded-xl border bg-slate-950/40 py-3 pl-10 pr-10 text-sm text-slate-100 placeholder-slate-500 transition-all duration-200 outline-none
                    ${errors.confirmPassword ? "border-rose-500/50 focus:border-rose-500 focus:ring-1 focus:ring-rose-500" : "border-slate-800 focus:border-indigo-500/80 focus:ring-1 focus:ring-indigo-500/80"}`}
                  placeholder="••••••••"
                />
                <button
                  type="button"
            ...
            <div className="flex items-start">
              <input
                ...
                type="checkbox"
                required
                className="h-4 w-4 mt-0.5 rounded border-slate-800 bg-slate-950/40 text-indigo-600 focus:ring-indigo-500/50 focus:ring-offset-slate-900 focus:outline-none"
              />
              <label htmlFor="terms" className="ml-2 block text-xs text-slate-400 select-none leading-relaxed">
                I agree to the{" "}
